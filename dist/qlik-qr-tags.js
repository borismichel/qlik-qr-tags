define(["qlik","jquery"], function(__WEBPACK_EXTERNAL_MODULE_qlik__, __WEBPACK_EXTERNAL_MODULE_jquery__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
    ...
    items: {
      ...
      about: {
        ...
        items: {
          ...
          paragraph1: {
            label: 'A button that creates links or QR tags so that the current sheet and selections can be shared with others.',
            component: 'text'
          },
          paragraph2: {
...
function paint($element, layout, component, qTheme) {
  ...
  var applicationId = app.model.layout.qFileName; //Adding breadcrumb for QR Code
  ...
  if (layout.outputMethod == "clipboard") {
    ...
    $element.html("".concat(button[0].outerHTML, "<canvas id=\"qrcode\" style=\"display: none; width:100%;height:100%\"></canvas>"));
    button = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#generateDashboardLink');
  }
  ...
  app.createCube({
    ...
    if (fieldSelections.length === 0) {
      ...
      Object(_utilities__WEBPACK_IMPORTED_MODULE_2__["addOnActivateButtonEvent"])($element, config, layout, baseURL, breadcrumb);
      return;
    }
    ...
    var selectionBC = Object(_utilities__WEBPACK_IMPORTED_MODULE_2__["createSelctionBreadcrumb"])(fieldSelections, TAG_SEPARATOR, VALUE_SEPARATOR, true);

    if (!selectionPartOfURL.tooManySelectionsPossible) {
      setButtonState(buttonText, false);
      suspectedFieldCount = 0;
      Object(_utilities__WEBPACK_IMPORTED_MODULE_2__["addOnActivateButtonEvent"])($element, config, layout, baseURL + selectionPartOfURL.selectionURLPart, breadcrumb + '\n' + selectionBC);
      return;
    }
...
/*!**************************!*\
  !*** ./src/utilities.js ***!
  \**************************/
/*! exports provided: createSelectionURLPart, createSelctionBreadcrumb, addOnActivateButtonEvent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createSelctionBreadcrumb", function() { return createSelctionBreadcrumb; });
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "jquery");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_qrcode_build_qrcode__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../node_modules/qrcode/build/qrcode */ "./node_modules/qrcode/build/qrcode.js");
/* harmony import */ var _node_modules_qrcode_build_qrcode__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_qrcode_build_qrcode__WEBPACK_IMPORTED_MODULE_1__);
...
function createSelctionBreadcrumb(fieldSelections, tagSeparator, valueSeparator, checkForTooManySelections) {
...
function addOnActivateButtonEvent($element, config, layout, url, breadcrumb) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#generateDashboardLink").on("qv-activate.".concat(LISTENER_NAMESPACE), function () {
    ...
    if (layout.outputMethod == "clipboard") {
      ...
      var canvas = document.getElementById('qrcode'); // Generate QR Code

      _node_modules_qrcode_build_qrcode__WEBPACK_IMPORTED_MODULE_1__["toCanvas"](canvas, decodeURIComponent(finalURL)); //open QR Code in new Window to enable prinitng and export

      var dataURL = canvas.toDataURL("image/png");
      var qrout = window.open();
      qrout.document.write( //create new window with QR Code
      "<html><head><title>Qlik Sense QR Code</title>         </head><body>         <img src=\"" + dataURL + "\"/>         <p style=\"font-family: sans-serif; font-weight: bold\">".concat(breadcrumb, "</p></ br></ br>         <p style=\"font-family: sans-serif; font-size: 8px\">TargetURL: ").concat(decodeURIComponent(finalURL), "</p>         </body></html>"));
      qrout.document.close(); //Changing the button's text temporarily to mark success
...
/******/ })});;
//# sourceMappingURL=qlik-qr-tags.js.map